...
var hours = void 0,
    ...
    day = void 0,
    month = void 0;
var currentTime = hours + ':' + minutes + ' ' + year + '-' + month + '-' + day;
// Weather API
var count = 1;
var C = void 0,
    F = void 0,
...
var amPm = void 0;
var countAlarms = 0;
var alarmArrTime = void 0;
var alarmArrDate = void 0;
...
$(function () {
  ...
  $('#submitInput').on('click', function () {
    ...
    var timeForm1 = parseInt(timeForm[0]);
    ...
    $('#deleteAlarm' + countAlarms).bind('click', function () {
      ...
      for (var i = 0; i < alarmArr.length; i++) {
        var index = alarmArr[i].alarmNumber.toString();
        var target = li[0].id;
        if (index === target) {
          alarmArr.splice(i, 1);
...
setInterval(function checkForAlarm() {
  ...
  if (alarmArr.length > 0) {
    for (var i = 0; i < alarmArr.length; i++) {
      alarmArrTime = alarmArr[i].alarmTime;
      alarmArrDate = alarmArr[i].alarmDate;
      var alaramArr = alarmArrTime + ' ' + alarmArrDate;
...
function success() {
  var voiceMessage = 'Good  morning  it is ' + timeForm + ' ' + amPm + ' todays date is' + date + ' and its ' + CF + '  degrees' + celOrFer + 'and' + weather + 'outside,  Have a great Day';
